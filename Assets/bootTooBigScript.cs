...
public class bootTooBigScript : MonoBehaviour {
    ...
    private string[][] Groups = new string[][] {
        ...
        new string[]{"Cursed Double-Oh", "DetoNATO", "Double-Oh", "Encryption Bingo", "Hot Potato", "Modulo", "Needy Piano", "Tic Tac Toe"}, 
